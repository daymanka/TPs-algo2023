...
public class BreadthFirstSearch {
	...
	*/
	private void push(int vertex) {
		ArrayList<Arc> randomOutEdges = new ArrayList<>(List.of(graph.outEdges(vertex)));
		// Mélanger des arcs sortants
		Collections.shuffle(randomOutEdges);
		for (Arc arc : randomOutEdges) {
			frontier.offer(arc);
		}
	}
